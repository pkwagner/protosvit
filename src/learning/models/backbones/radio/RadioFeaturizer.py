...
from src.learning.models.backbones.radio.utils import create_model
...
class RadioFeaturizer(nn.Module):
    ...
    def __init__(
        ...
        self.model = create_model(arch, img_size=img_size)
        self.patch_size = self.model.patch_size
        if arch == "eradio":
            self.n_feats = 1536
        else:
            self.n_feats = self.model.model.embed_dim
