...
# Adapted from https://github.com/pytorch/vision/blob/main/torchvision/datasets/oxford_iiit_pet.py
class OxfordIIITPet(VisionDataset):
    ...
    def __init__(
        ...
        split = split.replace("train", "trainval")
